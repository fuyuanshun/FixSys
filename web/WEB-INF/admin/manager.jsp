...
<nav class="nav">
    ...
    <p style="margin-left: 10px"><a href="/admin/loginout">退出</a></p>
</nav>
<div class="container">
        ...
        <tr>
            <td colspan="7">
                <ul class="pagination">
                    ...
                    <li class="page-item "><a class="page-link" href="/admin/Manager?currentPage=1">首页</a></li>
                    <li class="page-item "><a class="page-link" href="/admin/Manager?currentPage=<%=currentPage-1%>">上一页</a></li>
                    <li class="page-item "><a class="page-link" href="/admin/Manager?currentPage=<%=currentPage+1%>">下一页</a></li>
                    <li class="page-item "><a class="page-link" href="/admin/Manager?currentPage=${page.getTotalPage()}">尾页</a></li>
                </ul>
            </td>
        </tr>
    </table>
